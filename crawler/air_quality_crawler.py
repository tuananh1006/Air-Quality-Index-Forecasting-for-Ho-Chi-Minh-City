...
WEATHER_BIT_API_KEY = " "
INPUT_FILE = "../raw_data/xa_phuong_city_name_TPHCM.csv"
OUTPUT_FILE_TEMPLATE = "../raw_data/air_quality_city_{year}.csv"
SLEEP_TIME = 1
...
def fetch_air_quality(city_name, start_date, end_date):
    url = f"{BASE_URL}?city={city_name}&country=VN&start_date={start_date}&end_date={end_date}&key={WEATHER_BIT_API_KEY}"
    try:
...
if __name__ == "__main__":
    year = int(input("Nhập năm cần crawl (vd: 2024): "))
